      ...
      >
        ...
        <div className="form-control">
          ...
          <input
            ...
            className="input input-bordered border-[#b71b1c]"
          />
        </div>
        ...
        <div className="form-control">
          ...
          <select
            ...
            className="select select-bordered border-[#b71b1c]"
          >
        ...
        <div className="form-control md:col-span-2">
          ...
          <textarea
            ...
            className="textarea textarea-bordered border-[#b71b1c]"
          />
        </div>

        <button className="btn bg-[#b71b1c] text-white w-full md:col-span-2">
          Update Donation Request
        </button>
      </form>
    </div>
